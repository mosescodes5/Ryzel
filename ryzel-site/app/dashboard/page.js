...
function DashboardShell() {
  ...
  return (
    <div className="grid md:grid-cols-[240px_1fr] min-h-screen">
      <aside className="border-r border-line p-6 flex flex-col gap-6 items-stretch">
        <div className="flex items-center justify-between w-full">
          ...
          <button
            className="md:hidden text-ink-soft text-[0.85rem] font-semibold px-3 py-1.5 rounded-lg border border-line hover:bg-surface-hover"
            onClick={() =>
              setNavOpen((o) => !o)
            }
          >
  ...
  return (
    <div className="grid md:grid-cols-2 gap-6 items-start">
      <Card>
        ...
        {buyError && (
          <div className="bg-red-soft text-red text-[0.85rem] px-3 py-2.5 rounded-lg mt-3.5 flex items-center justify-between gap-3 flex-wrap">
            <span>{buyError}</span>
            {isInsufficientBalanceError(buyError) && (
              <button
    ...
    <div className="grid md:grid-cols-2 gap-6 items-start">
      <Card>
        ...
        <p className="text-[0.8rem] text-ink-faint">
          ...
          <a
            href="mailto:support@ryzel.online"
            className="text-signal underline"
          >
            Contact support
          </a>
