...
class Settings(BaseSettings):
    ...
    database_url: str = "sqlite:///./ryzel.db"
    ...
    # ---------------------------------------------------------
    # INVOICES & TRACKER (flat per-creation wallet fees)
    # ---------------------------------------------------------

    invoice_fee_ngn: float = 50.0

    tracker_fee_ngn: float = 50.0
    ...
    korapay_redirect_url: str = (
        "https://ryzel.online/wallet/topup/complete"
    )
    ...
    brevo_sender_email: str = "no-reply@ryzel.online"

    brevo_sender_name: str = "Ryzel"
